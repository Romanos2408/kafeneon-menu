(() => {
  ...
  const ICONS = {
    ...
    // teacup on saucer with tea-wave + handle + 3 sinuous steam wisps + ONE bigger leaf (filled solid)
    "tea": `<svg viewBox="0 0 24 24"><path d="M9 2c-.5 1-.5 2 0 3s.5 2 0 3"/><path d="M12 2c-.5 1-.5 2 0 3s.5 2 0 3"/><path d="M15 2c-.5 1-.5 2 0 3s.5 2 0 3"/><path d="M5 9h13v5a4 4 0 0 1-4 4H9a4 4 0 0 1-4-4V9z"/><path d="M5.5 12c2-1 4 1 6 0s4 1 6 0"/><path d="M18 11h2a2 2 0 0 1 0 4h-2"/><ellipse cx="12" cy="20" rx="10" ry="1.5"/><path d="M7.5 18C9 14 6 11 1.5 12C2 16 4 19 7.5 18Z" fill="currentColor"/></svg>`,
    ...
    // whiskey rocks glass — open rim, liquid level, two ice cubes (filled solid), foot line
    "drinks": `<svg viewBox="0 0 24 24"><ellipse cx="12" cy="5" rx="6.5" ry="1.5"/><path d="M5.5 5v13.5c0 1.5 13 1.5 13 0V5"/><path d="M5.5 11c0 1.5 13 1.5 13 0"/><rect x="7.5" y="10.5" width="4" height="4" rx="0.5" fill="currentColor"/><rect x="11" y="12.5" width="4" height="4" rx="0.5" fill="currentColor"/><path d="M7 20h10"/></svg>`,
    // lucide: beer
